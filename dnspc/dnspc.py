...
class PCRule(object):
    ...
    def is_match(self,src_ip=None,dst_str=None):
        ...
        return True
    def save(self):
        self.store.editRecord(self._serialize)
...
class ParentalControls(BaseResolver):
    ...
    def __init__(self):
        ...
        self.store = settings.DATA['RULES']
        self.load_rules()

    def load_rules(self):
        stored_rules = self.store.loadRecords()
    ...
    def add_rule(self,d=None,**kwargs):
        ...
        saved_rule = self.store.editRecord(kwargs)
    ...
    def del_rule(self,uid):
        ...
        self.store.deleteRecord({'_uid':uid})
